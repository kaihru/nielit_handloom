<a href="show_all_projects.php"><input class="btn btn-primary" type="button" value="Go Back" /> </a>
<a href="updateImages.php?id=<?php echo htmlspecialchars($edit ? $project['id'] : '', ENT_QUOTES, 'UTF-8'); ?>&operation=edit"><input class="btn btn-warning" type="button" value="Edit Details" /> </a>
        ...
        <div class="container">
            <div class="row"> 
                ...
                <h5>Materials At Site Images</h5> 
                    <?php 
                        if(!empty($edit)){          
                                $imageURL = 'assets/imgUploads/materialsOnsite/'.$project["onsite_images"];                                                   
                    ?>
                 
                            <?php echo' 
                            <img id="myImg" class="photo" onclick="showImage(this)" src="'.$imageURL.'" style="width: 20%; height: 20%;" /> '?>
                    ...
                    <?php } ?>
                     <?php 
                        if(!empty($query)){ $i=0;                            
                            foreach($query as $images) {$i++; 
                                $imageURL = 'assets/imgUploads/materialsOnsite/'.$images["materials_onsite_images"];                                                   
                    ?> 
                            <?php echo' 
                             <img id="myImg" class="photo" onclick="showImage(this)" src="'.$imageURL.'"   style="width: 24%; height: 50%;">'?>
                ...
                <div  class="col-md-12 text-dark">  
                <h5>Assets Status Images</h5> 
                       <?php 
                        if(!empty($assetsResult)){ $i=0;                            
                            foreach($assetsResult as $images) {$i++; 
                                $imageURL = 'assets/imgUploads/assetsStatus/'.$images["assets_images"];                                                   
                    ?> 
                            <?php echo' 
                             <img id="myImg" class="photo" onclick="showImage(this)" src="'.$imageURL.'"  style="width: 24%; height: 50%;">'?>
                ...
                <div  class="col-md-12 text-dark">  
                <h5>Maintenance Issue Images</h5> 
                       <?php 
                        if(!empty($maintenanceResult)){ $i=0;                            
                            foreach($maintenanceResult as $images) {$i++; 
                                $imageURL = 'assets/imgUploads/maintenanceIssue/'.$images["maintenance_issue_images"];                                                   
                    ?> 
                            <?php echo' 
                             <img id="myImg" class="photo" onclick="showImage(this)" src="'.$imageURL.'"  style="width: 24%; height: 50%;">'?>
                ...
                <div  class="col-md-12 text-dark">  
                <h5>Issues Fixed Image</h5> 
                       <?php 
                        if(!empty($issueFixedResult)){ $i=0;                            
                            foreach($issueFixedResult as $images) {$i++; 
                                $imageURL = 'assets/imgUploads/issueFixed/'.$images["issues_fixed_images"];                                                   
                    ?> 
                            <?php echo' 
                             <img id="myImg" class="photo" onclick="showImage(this)" src="'.$imageURL.'"  style="width: 24%; height: 50%;">'?>
